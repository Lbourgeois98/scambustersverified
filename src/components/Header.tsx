    ...
    >
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-4">
          <Link href="/" className="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg transition-colors">Home</Link>
          <Link href="/verify" className="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg transition-colors">Verify Agent</Link>
          <Link href="/agents" className="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg transition-colors">Verified Agents</Link>
          <Link href="/apply" className="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg transition-colors">Apply for Verification</Link>
          <Link href="/about" className="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg transition-colors">About Us</Link>
          <button 
