          ...
          <div className="relative">
            ...
            <div className="relative md:flex items-center mb-12">
              ...
              <div className="absolute left-1/2 transform -translate-x-1/2 flex items-center justify-center">
                <div className="bg-red-600 rounded-full h-12 w-12 flex items-center justify-center z-10">
            ...
            <div className="relative md:flex items-center mb-12">
              ...
              <div className="absolute left-1/2 transform -translate-x-1/2 flex items-center justify-center">
                <div className="bg-gold-500 rounded-full h-12 w-12 flex items-center justify-center z-10">
                  <Shield className="h-6 w-6 text-white" />
                </div>
              </div>
              
              <div className="md:w-1/2 md:pl-8">
                <h3 className="text-xl font-bold mb-2">Background Investigation</h3>
                <p className="text-gray-600">
            ...
            <div className="relative md:flex items-center mb-12">
              <div className="hidden md:block w-1/2 pr-8 text-right">
                <h3 className="text-xl font-bold mb-2">Compliance Check</h3>
                <p className="text-gray-600">
